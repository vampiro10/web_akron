            ...
            <div class="col-md-6 col-sm-12 col-12 col-lg-6 col-xl-6 d-flex align-items-center ">
                ...
                <div class="col-md-12">
                    ...
                    <p class="text-justify">
                        ...
                        <span>AKRON GASOLINERAS®</span> cuenta con Estaciones de Servicio diseñadas para destacar, cuidando cada detalle. Sus instalaciones innovadoras, la experiencia de usuario única y su combustible de última generación; vulven a <span>AKRON GASOLINERAS®</span> la opción más atractiva para cualquier tipo de cliente. 

                    </p>
                    <p>
                        Toda esta innovación se complementa con un modelo de negocio integral, que colocará a tu Estación de Servicio como la mejor opción.
                    </p>
    ...
    <div class="container justify-content-center">
        ...
        <div class="row justify-content-between my-5">
            ...
            <div class="col-md-3 col-sm-3 col-xl-3 d-flex align-items-end ">
                ...
                <a class="btn btn-custom-red" href="{{ route('contacto') }}">CONTACTAR</a>
