    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb position-relative">
                ...
                <li class="breadcrumb-item active" aria-current="page">Zona Akron</li>
...
<div class="row fondo-zona mx-0">

    <div class="row mt-5 align-items-center">

        <div class="col-md-6 text-right">

            <img class="img-pit-ser" src="{{asset('assets/img/services/pitlub.png')}}" alt="pitlub">

        </div>

        <div class="col-md-6">

            <h2 class="text-body">PIT LUB ANDARES</h2>    

            <p class="font-weight-light mt-3">
                Avenida Real Acueducto 160, 45116, Zapopan Jalisco.
            </p>
            <p class="font-weight-light mt-3">
                Servicios de Mantenimiento Preventivo y Cambio de Fluídos para Automóviles
            </p>


            <ul class="ul-custom mt-4">

                <li class="font-weight-light">Aceite de Motor</li> 

                <li class="font-weight-light">Dirección Hidráulica</li>

                <li class="font-weight-light">Anticongelante</li>

                <li class="font-weight-light">Frenos</li>

                <li class="font-weight-light">Nitrógeno</li>
