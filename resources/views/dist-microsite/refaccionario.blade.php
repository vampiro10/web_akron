    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="heder-breadcrumb">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('home')}}">Sé Distribuidor</a></li>

                <li class="breadcrumb-item active" aria-current="page">Refaccionario</li>
	...
	<div class="container">
		...
		<div class="row justify-content-center text-center">
			...
			<div class="col-md-10 dist-mensaje">
				...
				<p>Este registro es cuando ya cuentas con un negocio como: refaccionarias, talleres, expendios, locales, cambios de aceite, lava autos, etc. O bien, deseas poner un tipo de negocio de este tipo o cualquier otro, en el cual compres y vendas volúmenes menores a 15.000 litros mensuales de aceites, aditivos y grasas.</p>
				<p>
					Nota: Esta venta se realiza mediante distribuidor de la zona o centro de distribución propio, pero con mismas condiciones.
				</p>
...
<div class="distribuidor-banner">
	...
	<div class="container">
		...
		<div class="row align-items-center">
			...
			<div class="col-md-6 col-lg-7 db-titulo">
			...
			<div class="col-md-6 col-lg-5 db-enlaces">
