...
@section('contenido')
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="post post-gray d-flex align-items-center flex-md-row flex-column caja-img-link">
            <div class="caja-txt-home-gral">

              <h6>AKRON TECH</h6>

              <h2>AUMENTA EL RENDIMIENTO HASTA EL 10%</h2>
        ...
        <div class="col-lg-6">
          ...
          <div class="post post-gray d-flex align-items-center flex-md-row flex-column caja-img-link">
            <div class="caja-txt-home-gral">
              ...
              <h6>ACTITUD ABSOLUTA</h6>

              <p>Vive la pasión de nuestros embajadores y conoce cómo vivimos la actitud absoluta.</p>
    ...
    <div id="banner_akron">
      ...
      <div class="banner-akron" class="item d-flex align-items-center has-pattern">
        <div class="fondo-azul">
          <div class="caja-campos-home container">
        ...
        <div class="fondo-verde">
          ...
          <div class="caja-txt-home-ter">
            <img src="assets/img/botella_greenroad.png" alt="">
          </div>
          <img src="assets/img/greenroad_fondo.png" alt="">
          <img src="assets/img/greenroad_fondo_linea.png" alt="">
        </div>
  ...
  <section>
    ...
    <div class="container">
      ...
      <h5 class="txt-produ-d">PRODUCTOS</h5>
